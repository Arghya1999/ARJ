...
export default function Navigation() {
  ...
  const handleOpen = () => {
    // Function to handle opening the signin dialog
  };
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center px-11 ">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="#">
                  <span className="sr-only">ARJ</span>
                  <img
                    className="h-8 w-auto"
                    src="https://c7.alamy.com/comp/2RCRGTX/arj-logo-arj-letter-arj-letter-logo-design-initials-arj-logo-linked-with-circle-and-uppercase-monogram-logo-arj-typography-for-technology-busines-2RCRGTX.jpg"
                    alt=""
                  />
                </a>
              </div>
